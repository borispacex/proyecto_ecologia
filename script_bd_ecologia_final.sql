...
create table personas (
    ...
    color varchar(25) not null default 'theme-cyan',
    estado boolean not null default true,
    "createdAt" timestamp with time zone default ('now'::text)::timestamp(6) with time zone not null, 
    "updatedAt" timestamp with time zone default ('now'::text)::timestamp(6) with time zone not null, 
...
create table proyectos (
    ...
    -- basica general
    carrera varchar(100) default 'Biologia',
    n_instituto varchar(200) default 'Instituto de Ecologia',
    --  basica tecnica
    tipo varchar(100),
    area varchar(100),
    tipo_p varchar(100),
