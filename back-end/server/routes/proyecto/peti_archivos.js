...
module.exports = (app) => {
    ...
    app.get('/api/peti_archivosByEstado/:estado', peti_archivosController.getAllByEstado);
    ...
    app.get('/api/countPetiArchivosByIdPeticion/:id_peticion', peti_archivosController.countByIdPeticion);

    app.get('/api/peti_archivosByIdPeticionAndEstado/:id_peticion/:estado', peti_archivosController.getAllByIdPeticionAndEstado);
    app.get('/api/countPetiArchivosByIdPeticionAndEstado/:id_peticion/:estado', peti_archivosController.countByIdPeticionAndEstado);
}