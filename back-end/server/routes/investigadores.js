...
module.exports = (app) => {
    ...
    app.get('/api/investigadoresByIdInvTipo/:id_inv_tipo', investigadoresController.getAllByIdInvTipo);
    app.get('/api/investigador/:id_investigador', md_auth.auth, investigadoresController.getById);
    app.get('/api/investigadorByIdPersona/:id_persona', investigadoresController.getByIdPersona);
