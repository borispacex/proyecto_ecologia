...
module.exports = (app) => {
    ...
    app.get('/api/inv_proyectosByIdInvestigador/:id_investigador', inv_proyectosController.getAllByIdInvestigador);
    ...
    app.get('/api/inv_proyectosByIdInvestigadorAndEstado/:id_investigador/:estado', inv_proyectosController.getAllByIdInvestigadorAndEstado);
